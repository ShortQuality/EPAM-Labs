...
namespace Lab13_Generics
{
    ...
    class Lab13_Generics
    {
        static void Main(string[] args)
        {
            ...
            //CollectionType<Vector> secondCollect = new CollectionType<Vector>(rand.Next(1,5));                                    // т.е. для демонстрации работы класса CollectionType<T> с параметром в виде класса Vector
            ...
            //secondCollect = Value_entering(secondCollect, rand);
            //secondCollect.Sort();
